...
const TA = () => {
  ...
  useEffect(() => {
    fetch('TechnicalAnalysis.txt') // Update the path to your text file
  ...
  return (
    <div style={{ display: 'flex' }}>
      ...
      <Link to="/level2">
  <button style={{ marginTop: '20px', borderRadius: '20px', padding: '10px 20px', background: '#007bff', color: '#fff', border: 'none' }}>Next level</button>
</Link>
