...
# IMPORTING DATASET 
dataset = pd.read_csv('filled_stock_5_GOOGL.csv', usecols=[1,2,3,4])
...
model.fit(trainX, trainY, epochs=250, batch_size=2, verbose=2)
...
plt.ylabel('OHLC Value of GOOGL Stocks')
plt.show()
...
model.save('GOOGL_5.keras')

model = load_model('GOOGL_5.keras')
