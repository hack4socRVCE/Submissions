...
paragraphs = paragraphs_1 + paragraphs_2 + paragraphs_3 + paragraphs_4 + paragraphs_5

# Search a query using the word occurrences
query = "How to overcome stress in our daily life?"
max_occurrences_paragraph, max_occurrences = find_paragraph_with_highest_occurrences_ancient(remove_stopwords(query), paragraphs)
